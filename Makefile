...
TEST_CORE_FILES = $(wildcard tests/test*.cpp) tests/dynamic_graph_tests.cpp tests/quanta_glia_unit_tests.cpp tests/bdd/bdd_runner.cpp tests/bdd/bdd_test_main.cpp $(wildcard tests/bdd/steps/*.cpp) $(wildcard tests/print/*.cpp)
