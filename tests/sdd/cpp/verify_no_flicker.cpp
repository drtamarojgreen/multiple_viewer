...
int main() {
    ...
    if (ok) {
        std::cout << "SDD Card PASSED: No direct cout in rendering core." << std::endl;
        return 0;
    } else {
        std::cerr << "SDD Card FAILED: Direct cout found in rendering core, potential flickering." << std::endl;
        return 1;
    }
}
